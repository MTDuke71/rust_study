...
fn demonstrate_simple_memory_locations() {
    ...
    println!("  Size: {} bytes", std::mem::size_of::<SimpleLinkedList<String>>());
...
fn demonstrate_box_allocation_overhead() {
    ...
    println!("  Heap address: 0x{:x}", box_value.as_ref() as *const _ as usize);
    println!("  Stack pointer size: {} bytes", std::mem::size_of::<Box<i32>>());
