...
fn shared_list_structure() {
    ...
    println!(
        "\nCreated list b sharing a's tail, count = {}",
        Rc::strong_count(&a)
    );
    println!("b = {:?}", b);
    ...
    println!(
        "\nCreated list c sharing a's tail, count = {}",
        Rc::strong_count(&a)
    );
    println!("c = {:?}", c);
...
fn reference_counting_demo() {
    ...
    println!(
        "After collecting owners: count = {}",
        Rc::strong_count(&data)
    );

    drop(owners);
    println!(
        "After dropping all owners: count = {}",
        Rc::strong_count(&data)
    );
