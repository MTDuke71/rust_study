...
impl Config {
    ...
    fn show_usage() {
        ...
        eprintln!();
        eprintln!("USAGE:");
        eprintln!("    {} QUERY FILENAME", env::args().next().unwrap_or_else(|| "program".to_string()));
        eprintln!();
        eprintln!("ARGUMENTS:");
        ...
        eprintln!();
        eprintln!("EXAMPLES:");
        eprintln!("    {} nobody poem.txt", env::args().next().unwrap_or_else(|| "program".to_string()));
        eprintln!("    CASE_INSENSITIVE=1 {} NOBODY poem.txt", env::args().next().unwrap_or_else(|| "program".to_string()));
        eprintln!();
        eprintln!("OUTPUT:");
...
Trust me.";
    ...
    fn test_config_new_error_messages() {
        ...
        assert_eq!(expected_filename_error, "Missing required argument: FILENAME");
    }
