...
425,690,689";
    ...
    fn test_optimized_versions_match() {
        ...
        assert_eq!(result1, result1_opt, "Part 1: optimized version doesn't match original");
        ...
        assert_eq!(result2, result2_opt, "Part 2: optimized version doesn't match original");
    }
}
