...
fn benchmark_day08_distance_methods(c: &mut Criterion) {
    ...
    let input = fs::read_to_string("inputs/day08.txt").expect("Failed to read day08.txt");
    ...
    group.bench_function("part1_with_sqrt_f64", |b| {
        b.iter(|| aoc2025::solver::day08::solve_part1(black_box(&input)));
    });

    // Benchmark optimized i64 squared distance
    group.bench_function("part1_squared_i64", |b| {
        b.iter(|| aoc2025::solver::day08::solve_part1_optimized(black_box(&input)));
    });

    // Benchmark Part 2 as well
    group.bench_function("part2_with_sqrt_f64", |b| {
        b.iter(|| aoc2025::solver::day08::solve_part2(black_box(&input)));
    });

    group.bench_function("part2_squared_i64", |b| {
        b.iter(|| aoc2025::solver::day08::solve_part2_optimized(black_box(&input)));
    });
