...
fn main() {
    ...
    if test1_passed {
        ...
        println!("  Arrangement: {} (rotations of same solution)", 
    ...
    println!("  Test 1 (Part 1): {}", if test1_passed { "✅ PASS" } else { "❌ FAIL" });
    println!("  Test 2 (Part 2): {}", if test2_passed { "✅ PASS" } else { "❌ FAIL" });
    println!("  Test 3 (Subset): {}", if test3_passed { "✅ PASS" } else { "❌ FAIL" });
    println!("  
