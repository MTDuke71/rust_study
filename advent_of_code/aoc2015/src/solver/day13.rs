...
impl HappinessGraph {
    ...
    pub fn add_edge(&mut self, person_a: &str, person_b: &str, happiness: i32) {
        self.edges
            .insert((person_a.to_string(), person_b.to_string()), happiness);
    ...
    pub fn get_happiness(&self, person_a: &str, person_b: &str) -> i32 {
        self.edges
            .get(&(person_a.to_string(), person_b.to_string()))
            .copied()
            .unwrap_or(0)
    }
...
pub fn parse_happiness_graph(input: &str) -> Result<HappinessGraph> {
    ...
    for line in input.lines() {
        ...
        let happiness_value: i32 = happiness_str
            .parse()
