...
fn demo_aoc_2021_day15() {
    ...
    let expanded_end = Coord::new(
        expanded_grid.width as i32 - 1,
        expanded_grid.height as i32 - 1,
    );
...
fn demo_aoc_2021_day6() {
    ...
    // Parse initial state
    let fish_timers: Vec<u8> = initial_fish
        .split(',')
    ...
    println!(
        "    Day {}: {} fish (naive simulation)",
        small_days, naive_count
    );
...
fn demo_aoc_2020_day12() {
    ...
    let instructions: Vec<Instruction> = navigation_input
        .lines()
        .map(|line| {
            let line = line.trim();
    ...
    let pattern_applications = vec![
        ...
        (
            ...
            vec![
                ...
                "2019 Day 14 (Reactions)",
                "2015 Day 20 (Presents)",
            ],
