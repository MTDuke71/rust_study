...
impl StatePatternRecognizer {
    ...
    pub fn analyze_problem(&self, description: &str) -> Vec<String> {
        ...
        if lower_desc.contains("optimization")
            || lower_desc.contains("maximum")
            || lower_desc.contains("minimum")
        {
        ...
        if lower_desc.contains("intersection")
            || lower_desc.contains("union")
            || lower_desc.contains("common")
        {
