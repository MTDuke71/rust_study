...
use aoc2016::solver::{day01, day02, day03, day04, day05, day06, day07, day08, day09, day10, day11, day12, day13, day14, day15, day16, day17, day18, day20, day21, day22, day23};
...
fn bench_day21(c: &mut Criterion) {
    ...
    c.bench_function("day21_combined", |b| b.iter(|| day21::solve(input)));
    c.bench_function("day21_part1",   |b| b.iter(|| day21::solve_part1(input)));
    c.bench_function("day21_part2",   |b| b.iter(|| day21::solve_part2(input)));
}

fn bench_day22(c: &mut Criterion) {
    let input = include_str!("../inputs/day22.txt");
    c.bench_function("day22_combined", |b| b.iter(|| day22::solve(input)));
    c.bench_function("day22_part1",   |b| b.iter(|| day22::solve_part1(input)));
    c.bench_function("day22_part2",   |b| b.iter(|| day22::solve_part2(input)));
}

fn bench_day23(c: &mut Criterion) {
    let input = include_str!("../inputs/day23.txt");
    c.bench_function("day23_combined", |b| b.iter(|| day23::solve(input)));
    c.bench_function("day23_part1",   |b| b.iter(|| day23::solve_part1(input)));
    c.bench_function("day23_part2",   |b| b.iter(|| day23::solve_part2(input)));
}

criterion_group!(benches, bench_day01, bench_day02, bench_day03, bench_day04, bench_day05, bench_day06, bench_day07, bench_day08, bench_day09, bench_day10, bench_day11, bench_day12, bench_day13, bench_day14, bench_day15, bench_day16, bench_day17, bench_day18, bench_day20, bench_day21, bench_day22, bench_day23);
