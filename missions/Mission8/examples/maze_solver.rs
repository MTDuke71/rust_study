...
fn solve_maze(name: &str, maze: Maze) {
    ...
    match shortest_path(&maze, start, end) {
        Ok(path) => {
            ...
            println!(
                "  • Path efficiency: {:.1}% of walkable area",
...
fn create_large_maze() -> Maze {
    ...
    let grid = vec![
        ...
        vec![
            Wall, Start, Path, Path, Wall, Path, Path, Path, Path, Path, Path, Wall,
        ],
        vec![
            Wall, Wall, Wall, Path, Wall, Path, Wall, Wall, Wall, Wall, Path, Wall,
        ],
        vec![
            Wall, Path, Path, Path, Wall, Path, Wall, Path, Path, Path, Path, Wall,
        ],
        vec![
            Wall, Path, Wall, Wall, Wall, Path, Wall, Path, Wall, Wall, Wall, Wall,
        ],
        vec![
            Wall, Path, Path, Path, Path, Path, Wall, Path, Path, Path, Path, Wall,
        ],
        vec![
            Wall, Wall, Wall, Wall, Wall, Path, Wall, Wall, Wall, Path, Wall, Wall,
        ],
        vec![
        ...
        vec![
            Wall, Wall, Wall, Wall, Wall, Path, Wall, Wall, Path, Path, End, Wall,
        ],
        vec![
            Wall, Wall, Wall, Wall, Wall, Wall, Wall, Wall, Wall, Wall, Wall, Wall,
        ],
