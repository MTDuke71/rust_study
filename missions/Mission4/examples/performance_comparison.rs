...
fn memory_usage_analysis() {
    ...
    println!("  - Total per node: ~{} bytes + sizeof(T)", std::mem::size_of::<Box<()>>());
    ...
    println!("  - Rc overhead: ~{} bytes (ref count + weak count + data)", 
             std::mem::size_of::<std::rc::Rc<std::cell::RefCell<i32>>>());
    println!("  - RefCell overhead: ~{} bytes (borrow flag)", 
             std::mem::size_of::<std::cell::RefCell<i32>>() - std::mem::size_of::<i32>());
    println!("  - Weak reference: ~{} bytes", 
             std::mem::size_of::<std::rc::Weak<std::cell::RefCell<i32>>>());
    println!("  - Total per node: ~{} bytes + sizeof(T)", 
             std::mem::size_of::<std::rc::Rc<std::cell::RefCell<i32>>>() + 
             std::mem::size_of::<std::rc::Weak<std::cell::RefCell<i32>>>());
    ...
    println!("  SimpleLinkedList: ~{} bytes estimated", 
             SIZE * (std::mem::size_of::<i32>() + std::mem::size_of::<Box<()>>()));
    println!("  RcLinkedList: ~{} bytes estimated", 
             SIZE * (std::mem::size_of::<i32>() + 
                    std::mem::size_of::<std::rc::Rc<std::cell::RefCell<i32>>>() + 
                    std::mem::size_of::<std::rc::Weak<std::cell::RefCell<i32>>>()));
    
    let overhead_ratio = (std::mem::size_of::<std::rc::Rc<std::cell::RefCell<i32>>>() + 
                         std::mem::size_of::<std::rc::Weak<std::cell::RefCell<i32>>>()) as f64 / 
