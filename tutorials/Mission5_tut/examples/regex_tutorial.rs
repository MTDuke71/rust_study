...
fn step1_what_is_regex() {
    ...
    println!(
        "  Regex search: 'Find any 3-letter word ending in 'at'' - finds 'cat', 'bat', 'hat', etc."
    );
    println!();
...
fn step5_anchors() {
    ...
    let lines = vec!["cat in the hat", "a cat walked by", "catch the cat", "cat"];
