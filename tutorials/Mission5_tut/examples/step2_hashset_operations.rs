...
fn example_set_operations() {
    ...
    let rust_developers: HashSet<&str> = vec!["Alice", "Bob", "Charlie", "Diana"]
        .into_iter()
        .collect();
    let python_developers: HashSet<&str> =
        vec!["Bob", "Charlie", "Eve", "Frank"].into_iter().collect();
    let javascript_developers: HashSet<&str> = vec!["Alice", "Charlie", "Eve", "Grace"]
        .into_iter()
        .collect();
    ...
    let polyglot_rust_python: HashSet<_> =
        rust_developers.intersection(&python_developers).collect();
    println!(
        "🎯 Intersection (Rust ∩ Python): {:?}",
        polyglot_rust_python
    );
    ...
    let exclusive_skills: HashSet<_> = rust_developers
        .symmetric_difference(&python_developers)
        .collect();
    println!(
        "⚡ Symmetric difference (Rust ⊕ Python): {:?}",
        exclusive_skills
    );
...
fn example_set_comparisons() {
    ...
    let full_company: HashSet<&str> = vec!["Alice", "Bob", "Charlie", "Diana", "Eve"]
        .into_iter()
        .collect();
...
fn example_performance() {
    ...
    println!(
        "🛡️  Checking items against blacklist ({} entries):",
        blacklist.len()
    );
...
fn exercise_permission_analysis() {
    ...
    let read_users: HashSet<&str> = vec!["alice", "bob", "charlie", "diana"]
        .into_iter()
        .collect();
