...
fn main() {
    ...
    println!(
        "8-connected neighbors of {}: {} total",
        test_coord,
        neighbors_8.len()
    );
    ...
    println!(
        "Testing boundary handling for coordinate {}",
        boundary_coord
    );
    ...
    println!(
        "\nStraight-line distance from start to goal: {:.2}",
        heuristic_distance
    );
