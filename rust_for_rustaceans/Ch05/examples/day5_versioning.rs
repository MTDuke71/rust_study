...
fn semver_examples() {
    ...
    println!("\nChange detection:");
    println!(
        "  {}.is_breaking_change_from({}) = {}",
        v2_0_0,
        v1_1_1,
        v2_0_0.is_breaking_change_from(&v1_1_1)
    );
    println!(
        "  {}.is_feature_addition_from({}) = {}",
        v1_1_0,
        v1_0_0,
        v1_1_0.is_feature_addition_from(&v1_0_0)
    );
    println!(
        "  {}.is_bug_fix_from({}) = {}",
        v1_1_1,
        v1_1_0,
        v1_1_1.is_bug_fix_from(&v1_1_0)
    );
}
