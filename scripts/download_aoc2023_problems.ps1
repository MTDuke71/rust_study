# Download Advent of Code 2023 Problem Statements and Inputs
# Usage: .\scripts\download_aoc2023_problems.ps1 -SessionCookie "your_session_cookie_here"
...
if ([string]::IsNullOrWhiteSpace($SessionCookie)) {
    ...
    Write-Host '  .\scripts\download_aoc2023_problems.ps1 -SessionCookie "your_cookie_here"'
    Write-Host ""
    Write-Host "Option 2: Set environment variable:"
    Write-Host '  $env:AOC_SESSION = "your_cookie_here"'
    Write-Host '  .\scripts\download_aoc2023_problems.ps1'
    Write-Host ""
